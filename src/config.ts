...
export type TowerConfig = {
    ...
    special?: (integer) => number  // for unique behaviour of towers
    specialName?: string
...
export const Multishot: TowerConfig = {
    'name': "Multishot",
    'damage': level => 15 + 20*(level-1),
    'firerate': level => 1000,
    'range': level => 95 + 3*(level-1),
...
const SLOW_LIMIT = 0.4  // limit of the level => slow function
